 ...
 const fallbackProjects = [
  ...
  const fallbackCategories = [
    { name: 'ऊर्जा', count: 3, color: 'primary' },
    { name: 'जल व्यवस्थापन', count: 2, color: 'info' },
    { name: 'कल्याण', count: 4, color: 'success' },
    { name: 'पर्यावरण', count: 2, color: 'warning' },
    { name: 'तंत्रज्ञान', count: 1, color: 'danger' },
    { name: 'इतर', count: 1, color: 'secondary' }
  ];
