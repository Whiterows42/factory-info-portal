...
import { contactInfo, siteInfo } from '../../data/navigationData';
...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    alert('संदेश पाठवला गेला! आम्ही लवकरच संपर्क साधू.');
  };
          ...
          <div className="row g-5">
            ...
            <div className="col-lg-6">
              <div className="location-info bg-white p-4 rounded shadow-sm h-100">
                ...
                {/* Map Placeholder */}
                <div className="map-container mb-4" style={{ height: '300px', background: '#f8f9fa', border: '2px dashed #dee2e6' }}>
