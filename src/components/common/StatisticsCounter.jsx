...
// just down function delete for counter working properly ==const startCounters = () => {
  const startCounters = () => {
  ...
  statistics.forEach((stat) => {
    ...
    const targetNumber = typeof plain === 'string'
      ? parseInt(plain.replace(/[^\d]/g, ''))
      : plain;
  ...
  return (
    <section 
      ...
      style={{ 
        background: 'linear-gradient(135deg,rgb(20, 151, 226) 0%,rgb(26, 131, 218) 100%)', // R color changed
        color: 'white'
      }}
