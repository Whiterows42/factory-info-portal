...
const SEOHelmet = ({
  title = "श्री विघ्नहर सहकारी साखर कारखाना लि., जुन्नर / आंबेगाव",
  ...
  keywords = "श्री विघ्नहर सहकारी साखर कारखाना, sugar factory, junnar, ambegaon, cooperative society, factory information, farmer services, महाराष्ट्र, Maharashtra",
  ...
  useEffect(() => {
    ...
    updateMetaTag('og:site_name', 'श्री विघ्नहर सहकारी साखर कारखाना', true);
    ...
    const defaultStructuredData = {
      ...
      "@type": "Organization",
      "name": "श्री विघ्नहर सहकारी साखर कारखाना लि.",
