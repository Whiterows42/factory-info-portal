  ...
  const contactInfo =  {     // R small header data changed
    phone: '७७९६२८८५८२',
  ...
  const siteData =  {
    ...
    logoUrl: '/fev.jpg',   // header imagge
    // logoUrl: 'https://shrivighnaharssk.com/wp-content/uploads/2021/06/Name-Logo.png',  
    mobileLogoUrl: '/vitthal.jpg'
  };
